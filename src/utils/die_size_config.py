...
DIE_SIZE_CONFIG = {
    ...
    # Superblue设计使用更大的die size（基于组件数比例计算）
    "mgc_superblue16_a": ("0 0 10500 10500", "525 525 9975 9975"),  # 680K组件
    "mgc_superblue11_a": ("0 0 12300 12300", "615 615 11685 11685"),  # 925K组件
    "mgc_superblue12": ("0 0 14400 14400", "720 720 13680 13680"),  # 1.28M组件
